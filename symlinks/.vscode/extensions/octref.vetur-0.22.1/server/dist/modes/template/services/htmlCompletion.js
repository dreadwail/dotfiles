...
const isInsideInterpolation_1 = require("./isInsideInterpolation");
...
function doComplete(document, position, htmlDocument, tagProviders, emmetConfig, vueFileInfo) {
    ...
    const insideInterpolation = isInsideInterpolation_1.isInsideInterpolation(node, nodeText, document.offsetAt(position) - node.start);
