...
function getPrettyHtmlOptions(prettierrcOptions, vlsFormatConfig) {
    ...
    return Object.assign({}, fromVls, fromPrettier, { usePrettier: true, prettier: Object.assign({}, prettierrcOptions) }, vlsFormatConfig.defaultFormatterOptions['prettyhtml']);
}
