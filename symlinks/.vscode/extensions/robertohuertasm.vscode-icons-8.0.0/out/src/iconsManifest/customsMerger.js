...
class CustomsMerger {
    static merge(customFiles, extFiles, customFolders, extFolders, presets, projectDetectionResult, affectedPresets) {
        const angularPreset = this.getAngularPreset(presets, projectDetectionResult, affectedPresets);
    ...
    static getAngularPreset(presets, projectDetectionResult, affectedPresets) {
        ...
        return hasProjectDetectionResult &&
            ...
            : presets.angular ||
                (affectedPresets &&
                    ...
                    !manifestReader_1.ManifestReader.iconsDisabled(models.Projects.angular));
    }
    static toggleAngularPreset(disable, customFiles, defaultFiles) {
