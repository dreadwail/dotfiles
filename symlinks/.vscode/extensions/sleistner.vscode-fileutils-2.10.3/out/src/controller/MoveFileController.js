...
const AbstractFileController_1 = require("./AbstractFileController");
class MoveFileController extends AbstractFileController_1.AbstractFileController {
    showDialog(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (targetPath) {
                ...
                return new Item_1.FileItem(sourcePath, realPath);
            }
        });
    }
    execute(options) {
