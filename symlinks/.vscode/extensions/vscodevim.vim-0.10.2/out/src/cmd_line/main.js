...
function showCmdLine(initialText, modeHandler) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const options = {
            ...
            value: configuration_1.Configuration.cmdLineInitialColon ? ':' + initialText : initialText,
            ignoreFocusOut: false,
            valueSelection: [
                configuration_1.Configuration.cmdLineInitialColon ? initialText.length + 1 : initialText.length,
                configuration_1.Configuration.cmdLineInitialColon ? initialText.length + 1 : initialText.length,
            ],
        };
        try {
            const cmdString = yield vscode.window.showInputBox(options);
            const trimmedCmdString = cmdString && configuration_1.Configuration.cmdLineInitialColon && cmdString[0] === ':'
                ? cmdString.slice(1)
                : cmdString;
            yield runCmdLine(trimmedCmdString, modeHandler);
            return;
        }
        catch (e) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (configuration_1.Configuration.enableNeovim &&
                ...
                yield nvimUtil_1.Neovim.command(modeHandler.vimState, command)
                    .then(() => {
