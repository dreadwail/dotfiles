    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!curHandler) {
            if (!configuration_1.Configuration.disableAnnoyingNeovimMessage) {
                vscode.window
                    .showInformationMessage('We have now added neovim integration for Ex-commands.\
      Enable it with vim.enableNeovim in settings', 'Never show again')
                    .then(result => {
                    if (result !== 'Close') {
                        vscode.workspace
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        registerCommand(context, 'toggleVim', () => __awaiter(this, void 0, void 0, function* () {
            ...
            if (globals_1.Globals.active) {
                ...
                let cursorStyle = yield vscode.workspace
