...
class Remapper {
    ...
    _getRemappings() {
        ...
        for (let remapping of configuration_1.configuration[this._configKey]) {
            ...
            if (!isCommandValid) {
                logger_1.logger.error(`Remapper: ${this._configKey}. Invalid configuration. Command does not exist. ${debugMsg}.`);
                continue;
            }
            ...
            logger_1.logger.debug(`Remapper: ${this._configKey}. loaded: ${debugMsg}`);
