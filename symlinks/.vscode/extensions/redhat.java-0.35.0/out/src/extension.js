...
let lastStatus;
let languageClient;
let jdtEventEmitter = new vscode_1.EventEmitter();
        ...
        return vscode_1.window.withProgress({ location: vscode_1.ProgressLocation.Window }, p => {
            return new Promise((resolve, reject) => {
                ...
                languageClient.onReady().then(() => {
                    ...
                    vscode_1.commands.registerCommand(commands_1.Commands.UPDATE_SOURCE_ATTACHMENT, (classFileUri) => __awaiter(this, void 0, void 0, function* () {
