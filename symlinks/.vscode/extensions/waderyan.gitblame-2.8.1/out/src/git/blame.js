...
class GitBlame {
    ...
    dispose() {
        this.files.forEach((file, key) => __awaiter(this, void 0, void 0, function* () {
            const fileResult = yield file;
            if (fileResult) {
                fileResult.dispose();
            }
            else {
    ...
    getBlameInfo(fileName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const blameFile = yield this.files.get(fileName);
            if (blameFile) {
    ...
    isToolUrlPlural(origin) {
        const isWebPathPlural = property_1.Property.get("isWebPathPlural");
        if (isWebPathPlural === true) {
            return true;
        }
        const urlParts = property_1.Property.get("pluralWebPathSubstrings");
