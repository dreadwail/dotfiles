...
class GitFilePhysical extends file_1.GitFile {
    ...
    findBlameInfo() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (workTree) {
                this.blameInfoPromise = new Promise((resolve) => {
                    ...
                    this.blameProcess.on("end", this.gitStreamOver(this.blameProcess, resolve, blameInfo));
                });
            }
            else {
                view_1.StatusBarView.getInstance().stopProgress();
    ...
    gitStreamOver(gitStream, resolve, blameInfo) {
        return (err) => {
