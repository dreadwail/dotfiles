...
class LineRange {
    ...
    toString() {
        var _a, _b;
        return this.left.toString() + ((_b = (_a = this.separator) === null || _a === void 0 ? void 0 : _a.content) !== null && _b !== void 0 ? _b : '') + this.right.toString();
    }
...
class CommandLine {
    ...
    toString() {
        var _a, _b;
        return ':' + this.range.toString() + ' ' + ((_b = (_a = this.command) === null || _a === void 0 ? void 0 : _a.toString()) !== null && _b !== void 0 ? _b : '');
    }
    execute(document, vimState) {
