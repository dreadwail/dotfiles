...
class SubstituteCommand extends node.CommandBase {
    ...
    getRegex(args, vimState) {
        let jsRegexFlags = '';
        if (configuration_1.configuration.gdefault || configuration_1.configuration.substituteGlobalFlag) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this._arguments.flags & SubstituteFlags.ConfirmEach) {
                ...
                for (const match of matches) {
                    ...
                    if (!(this._arguments.flags & SubstituteFlags.ConfirmEach) ||
                        (yield this.confirmReplacement(this._arguments.replace, line, vimState, match, matchPos))) {
