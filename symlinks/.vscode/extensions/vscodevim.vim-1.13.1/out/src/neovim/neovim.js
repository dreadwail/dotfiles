...
class NeovimWrapper {
    ...
    run(vimState, command) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.syncVSCodeToVim(vimState);
            command = (':' + command + '\n').replace('<', '<lt>');
            ...
            yield this.syncVimToVSCode(vimState);
    ...
    syncVSCodeToVim(vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.nvim.setOption('gdefault', configuration_1.configuration.gdefault === true);
    ...
    syncVimToVSCode(vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield textEditor_1.TextEditor.replace(new vscode.Range(0, 0, lineCount - 1, textEditor_1.TextEditor.getLineLength(lineCount - 1)), fixedLines.join('\n'));
