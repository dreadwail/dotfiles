...
class HistoryTracker {
    ...
    updateAndReturnMarks() {
        ...
        for (const mark of previousMarks) {
            newMarks.push(Object.assign({}, mark));
        }
    ...
    getAllCurrentDocumentMarks() {
        const globalMarks = HistoryStep.globalMarks.filter(mark => mark.editor === vscode.window.activeTextEditor);
    ...
    _isDocumentTextNeeded() {
        ...
        const isNewHistoryStep = (this.currentHistoryStepIndex === this.historySteps.length - 1 &&
    ...
    addChange(cursorPosition = [new position_1.Position(0, 0)]) {
        if (configuration_1.configuration.experimentalOptimizations && !this._isDocumentTextNeeded()) {
            return false;
        }
    ...
    goBackHistoryStep() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            statusBar_1.StatusBar.setText(this.vimState, `${changes}; before #${this.currentHistoryStepIndex}  ${step.howLongAgo()}`);
            this.currentHistoryStepIndex--;
    ...
    goForwardHistoryStep() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const changes = step.changes.length === 1 ? `1 change` : `${step.changes.length} changes`;
            statusBar_1.StatusBar.setText(this.vimState, `${changes}; after #${this.currentHistoryStepIndex}  ${step.howLongAgo()}`);
