...
class TextObjectMovement extends baseMotion_1.BaseMovement {
    constructor() {
        super(...arguments);
...
class IndentObjectMatch extends TextObjectMovement {
    ...
    execAction(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let endCharacter;
            if (endLineNumber === textEditor_1.TextEditor.getLineCount() - 1 || vimState.currentMode === mode_1.Mode.Visual) {
