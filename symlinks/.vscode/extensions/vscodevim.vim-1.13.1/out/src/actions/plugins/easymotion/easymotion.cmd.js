            ...
            if (!configuration_1.configuration.easymotion) {
                ...
                if (matches.length === 0) {
                    ...
                    if (matches.length === 1) {
                        ...
                        yield vimState.setCurrentMode(mode_1.Mode.EasyMotionMode);
                        return vimState;
                    }
                }
            }
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!configuration_1.configuration.easymotion) {
                ...
                yield vimState.setCurrentMode(mode_1.Mode.EasyMotionInputMode);
                return vimState;
            }
        });
    }
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!key) {
                ...
                if (vimState.easyMotion.previousMode === mode_1.Mode.Visual ||
                    vimState.easyMotion.previousMode === mode_1.Mode.VisualLine ||
                    vimState.easyMotion.previousMode === mode_1.Mode.VisualBlock) {
