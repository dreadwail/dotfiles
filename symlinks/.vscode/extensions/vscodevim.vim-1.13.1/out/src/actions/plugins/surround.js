...
let CommandSurroundAddTarget = class CommandSurroundAddTarget extends actions_1.BaseCommand {
    constructor() {
        super(...arguments);
        this.modes = [mode_1.Mode.SurroundInputMode];
        this.keys = [
            ['('],
            [')'],
            ['{'],
...
// can't find a match.
let CommandSurroundModeRepeat = class CommandSurroundModeRepeat extends baseMotion_1.BaseMovement {
    constructor() {
        super(...arguments);
...
let CommandSurroundModeStart = class CommandSurroundModeStart extends actions_1.BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            else if (operator instanceof operator_1.DeleteOperator) {
                operatorString = 'delete';
            }
            else if (operator instanceof operator_1.YankOperator) {
                operatorString = 'yank';
            }
            if (!operatorString) {
                return vimState;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (operator === 'yank') {
                ...
                vimState.recordedState.transformations.push({
                    ...
                    diff: new position_1.PositionDiff({ character: -startReplace.length }),
                });
                vimState.recordedState.transformations.push({
                    type: 'insertText',
                    text: endReplace,
            ...
            if (target === 't') {
                ...
                let innerTagContent = yield new motion_1.MoveInsideTag().execAction(position, vimState);
