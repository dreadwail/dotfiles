    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (vimState.recordedState.count > 1 && isTypeToRepeatInsert) {
                ...
                let positionDiff = new position_1.PositionDiff();
                ...
                for (let i = 0; i < vimState.recordedState.count - 1; i++) {
                    ...
                    if (i === vimState.recordedState.count - 2) {
                        positionDiff = new position_1.PositionDiff({ character: -1 });
                    }
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            vimState.recordedState.transformations.push({
                ...
                diff: new position_1.PositionDiff({ character: newIndentationWidth - indentationWidth }),
            });
            return vimState;
        });
    }
...
//   }
// }
let CommandBackspaceInInsertMode = class CommandBackspaceInInsertMode extends actions_1.BaseCommand {
    constructor() {
        super(...arguments);
        this.modes = [mode_1.Mode.Insert];
        this.keys = ['<BS>'];
...
CommandBackspaceInInsertMode = __decorate([
    base_1.RegisterAction
], CommandBackspaceInInsertMode);
exports.CommandBackspaceInInsertMode = CommandBackspaceInInsertMode;
let CommandDeleteInInsertMode = class CommandDeleteInInsertMode extends actions_1.BaseCommand {
    constructor() {
        super(...arguments);
        this.modes = [mode_1.Mode.Insert];
        this.keys = ['<Del>'];
...
exports.CommandDeleteInInsertMode = CommandDeleteInInsertMode;
